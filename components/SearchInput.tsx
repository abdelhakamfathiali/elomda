...
const SearchInput = () => {
  ...
  return (
    <div
      ...
      className="w-[750px]  h-14 mx-4 hidden md:inline-flex items-center justify-between relative">
      <input
        className="w-full h-full rounded-md rounded-br-md px-2 placeholder:text-sm text-base text-black placeholder:text-black/70 border-[3px] border-transparent outline-none focus-visible:border-amazonOrange"
        type="text"
      ...
      <span className="w-12 h-full hover:bg-amazonYellowDark duration-200 cursor-pointer text-black text-2xl flex items-center justify-center absolute right-0 rounded-tr-md rounded-br-md">
        <HiOutlineSearch />
      </span>
