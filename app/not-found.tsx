...
const NotFoundPage = () => {
  return (
    <div className="bg-white w-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-5 md:py-20">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="bg-amazonBlue w-28 p-2 rounded-sm mx-auto">
            <Image src={"/1.png"} alt="Amazon Logo" width={180} height={100} />
          </div>
